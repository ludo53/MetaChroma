...
#[derive(Debug)]
pub struct MetaChromaProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MetaChromaProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MetaChroma processing");
    
    let mut processor = MetaChromaProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MetaChromaProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MetaChromaProcessor::new(false);
